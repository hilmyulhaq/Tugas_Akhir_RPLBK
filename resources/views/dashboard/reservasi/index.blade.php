        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="table-responsive col-lg-12">
                    <a href="/dashboard/reservasis/recycle" class="btn btn-danger mb-3"><i class="fas fa-trash"></i> Sampah
                        Penolakan</a>
                    <div class="card mb-4">
                                ...
                                <tbody>
                                    @foreach ($reservasis as $reservasi)
                                        <tr>
                                            ...
                                            <td>{{ $reservasi->persetujuan }}</td>
                                            <td class="d-flex justify-content-center">
                                                <a href="#" data-bs-toggle="modal"
                                                    data-bs-target="#detail{{ $reservasi->id }}"
                                                    class="btn btn-warning">Detail</a>
                                                <form action="{{ route('reservasis.approve', $reservasi->id) }}"
                                                    method="POST" class="mx-1 d-inline">
                                                    @csrf
                                                    <button type="submit" class="btn btn-success">Menyetujui</button>
                                                </form>
                                                <form action="/dashboard/reservasis/{{ $reservasi->id }}" method="POST"
                                                    ...
                                                    <button class="btn btn-danger"
                                                        onclick="return confirm('Apakah Admin Yakin Menghapusnya ?')">Menolak</button>
                                                </form>
                                            </td>
                                        </tr>
                                        {{-- Modal --}}
