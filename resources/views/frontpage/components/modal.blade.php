            ...
            <div class="modal-body">
                <form action="/dashboard/reservasis" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_paket" aria-describedby="nama_paket"
                            name="nama_paket" value="{{ $paket->nama_paket }}" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="keterangan_paket" class="form-label">Keterangan Dari Paket</label>
                        <input type="text" class="form-control" id="keterangan_paket"
                            aria-describedby="keterangan_paket" name="keterangan_paket"
                            value="{{ $paket->keterangan_paket }}" readonly>
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="harga" aria-describedby="harga"
                            name="harga" value="{{ $paket->harga }}" readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="no_pelanggan" aria-describedby="no_pelanggan"
                            name="no_pelanggan" required>
                    </div>
                    <div class="mb-3">
                        <label for="nama_barber" class="form-label">Pilih Barber</label>
                        <select class="form-control" id="nama_barber" aria-describedby="nama_barber" name="nama_barber"
                            required>
                            <option value="Ega">Ega</option>
                            <option value="Hilmy">Hilmy</option>
                            <option value="Hilmy Abdul">Hilmy Abdul</option>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="jam_potong" class="form-label">Waktu Potong</label>
                        <input type="text" class="form-control" id="jam_potong" aria-describedby="jam_potong"
                            name="jam_potong" required>
                    </div>
